    ...
    */
    ...
    var Scroller = /** @class */ (function (_super) {
        ...
        Scroller.prototype.render = function () {
            ...
            if (liquid) {
                if (liquidIsAbsolute) {
                    className.push('fc-scroller-liquid-absolute priceSettingPage');
                }
                else {
    ...
    var TableCellTop = /** @class */ (function (_super) {
        ...
        TableCellTop.prototype.render = function () {
            ...
            return (createElement(DayCellContent, { date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, defaultContent: renderTopInner }, function (innerElRef, innerContent) { return ((innerContent || props.forceDayTop) && (createElement("div", { className: "fc-daygrid-day-top", ref: innerElRef },
                createElement("a", __assign({ id: props.dayNumberId, className: "fc-daygrid-day-number",  onclick:"" }, navLinkAttrs), innerContent || createElement(Fragment, null, "\u00A0"))))); }));

            //'app1-click':"newObj('seats')"
        };
        return TableCellTop;
    }(BaseComponent));
        ...
        TableRow.prototype.renderFgSegs = function (col, segPlacements, todayRange, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            if (framePositions) {
                for (var _i = 0, segPlacements_1 = segPlacements; _i < segPlacements_1.length; _i++) {
                    ...
                    console.log(seg.eventRange.def.groupId)
                    var instanceId = seg.eventRange.instance.instanceId;
                    ...
                    */
                    ...
                    //,'app-click': "viewSeat('"+seg.eventRange.def.groupId+"')"
